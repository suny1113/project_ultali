			...
			<div id="contents">
				<table>
					...
					<tr>
						...
						<td><input type="text" name="c_name" id="" class="input" value="${dto.c_name }"/></td>
					</tr>
...
<!-- 							https://www.gaok.or.kr/gaok/main/contents.do?menuNo=200107  참고함 -->
					...
					<tr>
						...
						<td><input type="text" name="c_place" id="" class="input" value="${dto.c_place }"/></td>
					</tr>
					...
					<tr>
						...
						<td><input type="text" name="c_time" id="" class="input" value="${dto.c_time }"/></td>
					</tr>
					
					<tr>
						<td><p class="category">모집인원</p></td>
						<td><input type="number" name="c_count" id="" class="input2" value="${dto.c_count }" style="width: 30px;"/><span class="category" style="margin-left: 5px;">명</span></td>
					</tr>
					
					<tr>
						<td><p class="category">비용</p></td>
						<td><input type="number" name="c_price" id="" class="input2" style="width: 80px; " value="${dto.c_price }"/><span class="category" style="margin-left: 5px;">원</span></td>
					</tr>
				...
				<textarea rows="10" cols="70" name="c_detail">${dto.c_detail }</textarea>
				<div>
