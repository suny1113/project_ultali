...
<body>
				...
				<div id="contents">
					<table>
						<tr>
							...
							<td><input type="text" class="content" name="c_name" id="input" class="input" value="${dto.c_name }"/></td>
						</tr>
	...
	<!-- 							https://www.gaok.or.kr/gaok/main/contents.do?menuNo=200107  참고함 -->
						...
						<tr>
							...
							<td><input type="text" class="content" name="c_place" id="" value="${dto.c_place }" class="input"/></td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" class="content" name="c_time" id="" value="${dto.c_time }" class="input" /></td>
						</tr>
						
						<tr>
							<td><span class="category subTitle">모집인원</span></td>
							<td><input type="number" class="content" name="c_count" id="" value="${dto.c_count }" class="input2" style="width: 30px;"/><span style="margin-left: 5px;">명</span></td>
						</tr>
						
						<tr>
							<td><span class="category subTitle">비용</span></td>
							<td><input type="number" class="content" name="c_price" id="" class="input2" style="width: 80px; " value="${dto.c_price }"/><span style="margin-left: 5px;">원</span></td>
						</tr>
						...
						<tr>
							...
							<td><textarea rows="10" cols="50" name="c_detail" id="area">${dto.c_detail }</textarea></td>
						</tr>
					</table>
					<div>
