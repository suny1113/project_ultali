				...
				<input type="hidden" name="wish" id="wish" value="${wish }"/>
					<div id=container>
						<div id="main">
							...
							<h3 id="title">게시물 제목</h3>					
							<table>
								<tr>
									<td><p class="contents subtitle">모집분야</p></td>
								...
								<tr>
									<td class="contents subtitle"><p>활동지역</p></td>
									<td><p class="contents detail">${dto.c_loc }</p></td>
								</tr>
								
								<tr>
									<td><p class="contents subtitle">세부장소</p></td>
									<td><p class="contents detail">${dto.c_place }</p></td>
								</tr>
								
								<tr>
									<td><p class="contents subtitle">모임일정</p></td>
									<td><p class="contents detail">${dto.c_date }</p></td>
								</tr>
								
								<tr>
									<td><p class="contents subtitle">비용</p></td>
									<td><p class="contents detail">${dto.c_price }</p></td>
								</tr>
								
								<tr>
									<td ><p class="contents subtitle">모집인원</p></td>
									<td ><p class="contents detail">${dto.c_count }</p></td>
								</tr>
							</table>
							
							<h3 id="detail_contents">상세 설명</h3>
							<textarea name="" id="detail_content" cols="30" rows="10" disabled > 모임명: ${dto.c_name }&#10;&#10;&#10; 상세설명: ${dto.c_detail }  </textarea>
