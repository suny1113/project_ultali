...
개인정보 수집 및 이용 안내
주식회사 울타리(이하 “회사”)는 회원님의 개인정보를 보호하기 위해 최선을 다하고 있습니다. 이를 위해서 회사는 개인정보의 보호와 관련하여 ‘정보통신망 이용촉진 및 정보보호 등에 관한 법률’, ‘개인정보 보호법’ 등 개인정보와 관련된 법령을 준수하고 있습니다.
...
다. 개인정보의 수정을 요청하는 경우 회사는 정확한 개인정보의 이용 및 제공을 위해 수정이 완료될 때까지 이용자의 개인정보는 이용하거나 제공하지 않습니다.

8. 개인정보 파기절차 및 방법
고객 또는 이용자가 고객정보카드에 기재하거나, 웹사이트 회원가입 등을 위해 입력한 정보는 목적이 달성된 후 별도의 DB로 옮겨져(출력물의 경우 별도의 서류함) 내부 방침 및 기타 관계법령에 따라 일정 기간 저장된 후 파기됩니다.
회사는 정보가 저장된 유형에 따라 완전파괴(소각·파쇄 등), 전용 소자장비를 이용한 삭제, 데이터가 복원되지 않도록 초기화 또는 덮어쓰기 수행 등의 방법으로 파기합니다.
...
13. 시행시기
본 개인정보처리방침은 2021년 3월 18일부터 시행됩니다.
		</p>
		</div>
	</div>		
